...
/* [201603] Single SKU */
bool nfc_fw_get_image(tNFC_HAL_FW_INFO *fw, char *file_name, uint8_t keyType, bool force)
{
...
void fw_force_update(void *param)
{
    ...
    // TODO: error handle
/* [201603] Single SKU */
    if (nfc_fw_get_image(fw, nfc_hal_info.cfg.fw_file, bl->version[NFC_HAL_BL_VER_KEYINFO], true))
/* [201603] End */
    {
